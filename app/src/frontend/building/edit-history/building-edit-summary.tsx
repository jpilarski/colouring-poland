...
const BuildingEditSummary: React.FunctionComponent<BuildingEditSummaryProps> = ({
    ...
    const categoryHyperlinkTemplate = hyperlinkCategories && historyEntry.lokalizacja_id_budynku != undefined ?
        `/edit/$category/${historyEntry.lokalizacja_id_budynku}` :
        undefined;
    ...
    return (
        <div className="edit-history-entry">
            ...
            {
                showBuildingId && historyEntry.lokalizacja_id_budynku != undefined &&
                <h3 className="edit-history-building-id">
                    Building <Link to={`/edit/categories/${historyEntry.lokalizacja_id_budynku}`}>{historyEntry.lokalizacja_id_budynku}</Link>
                </h3>
            }
            {

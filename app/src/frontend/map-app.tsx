...
export const MapApp: React.FC<MapAppProps> = props => {
    ...
    const selectBuilding = useCallback((selectedBuilding: Building) => {
        ...
        setSelectedBuildingId(setOrToggle(currentId, selectedBuilding?.lokalizacja_id_budynku));
    }, [selectedBuildingId, setSelectedBuildingId, updateBuilding, building]);

    const colourBuilding = useCallback(async (building: Building) => {
        const buildingId = building?.lokalizacja_id_budynku;
        ...
        <>
            ...
            <Sidebar>
                <Switch>
                    ...
                    <Route path="/:mode/:cat">
                        <Categories mode={mode || 'view'} lokalizacja_id_budynku={selectedBuildingId} />
                        <Switch>
